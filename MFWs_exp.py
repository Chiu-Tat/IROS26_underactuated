...
if __name__ == "__main__":
    ...
    Plot_Hull_H_2D(N, d, radius=0.02)
    ...
    Plot_Hull_H_2D(N, d, radius=0.03)
    ...
    A_3 = Extract_Map_I2B(target_point3) @ Map_I2B(target_point3)
    N, d = Transform_and_Extract_Facets(A_3, G, k)
